        ...
        <div className="space-y-4">
          ...
          <Card className="rounded-none border-2 bg-white shadow-sm">
            ...
            <CardContent className="p-4 space-y-2">
              ...
              <div className="space-y-1">
                <Label className="text-[10px] font-black uppercase">Meta SEO Title</Label>
              ...
              <div className="space-y-1">
                <Label className="text-[10px] font-black uppercase">Meta Description (Excerpt)</Label>
              ...
              <div className="space-y-1">
                <Label className="text-[10px] font-black uppercase">Publish Date</Label>
                <Input value={formData.date} onChange={e => setFormData({...formData, date: e.target.value})} className="h-8 text-xs rounded-none" />
              </div>
              <div className="space-y-1">
                <Label className="text-[10px] font-black uppercase">Author Name</Label>
